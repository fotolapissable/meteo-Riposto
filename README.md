...
- **Mappa base**: OpenStreetMap standard, resa scura via filtro CSS dedicato (isolato in un pane separato da radar/satellite/fulmini, che mantengono i colori originali)
...
| [RainViewer](https://rainviewer.com/api.html) | `api.rainviewer.com` + `tilecache.rainviewer.com` | nessuna | Radar precipitazioni, satellite IR |
